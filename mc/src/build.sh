...
INCLUDE="-I../libs/glfw/linux/include -I../libs/stb -I../libs -I../libs/simplex/src -I../libs/glad/ -I../../libs -I../../libs/simplex/src"
...
if [ "$1" == "run" ]; then
	...
	time g++ $MODE glfw_mc.cpp -o ../build/game $CFLAGS $LDFLAGS
	rm -f ../build/mc.a
	...
	## WASM -s INITIAL_MEMORY=<X> -s PTHREAD_POOL_SIZE=2 -s USE_PTHREADS=1
	...
	time emcc ../../src/web_mc.cpp ../../src/mc.cpp ../../libs/simplex/src/SimplexNoise.cpp -o index.js $INCLUDE $WASM_FLAGS --preload-file assets
	popd
fi
